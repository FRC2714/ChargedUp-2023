...
public final class Constants {
  ...
  public static final class ArmConstants {
    ...
    public static final double kElbowEncoderZeroOffset = 230.2364949;
    public static final double kShoulderKinematicOffset = 45; //difference from kinematic 0 to sparkmax 0 approx 45 deg
    public static final double kElbowKinematicOffset = 630; //difference from kinematic 0 to sparkmax 0 approx 160 deg
    ...
    public static final boolean kElbowEncoderInverted = false; //second joint motor and encoder are NOT inverted
    ...
    public static final int kElbowMotorCurrentLimit = 10; //amps PREVENT ENDCAP ROUNDOUT
