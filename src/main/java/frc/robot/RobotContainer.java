...
public class RobotContainer {
	...
	public Command getTwoCubeOpenAuto() {
		return new TwoCubeOpenAuto(m_robotDrive, m_armStateMachine, m_intake, m_arm, m_claw, m_backLimelight);
	}
	...
	public Command getTwoCubeOpenAutoStop() {
		return new TwoCubeOpenAutoStop(m_robotDrive, m_armStateMachine, m_intake, m_arm, m_claw, m_backLimelight);
	}

	public Command getOneCubeTerrainAuto() {
		return new OneCubeTerrainAuto(m_robotDrive, m_armStateMachine, m_intake, m_arm, m_claw, m_backLimelight);
	}
}
