...
public class OneConeBalanceMiddleAuto extends AutoBase {
	...
	public OneConeBalanceMiddleAuto(DriveSubsystem m_robotDrive, ArmStateMachine m_armStateMachine, Shooter m_intake, Arm m_arm, Claw m_claw, Limelight m_limelight) {
		super(m_robotDrive);
