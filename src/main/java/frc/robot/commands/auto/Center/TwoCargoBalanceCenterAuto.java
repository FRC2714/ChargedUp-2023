...
public class TwoCargoBalanceCenterAuto extends AutoBase {
	...
	public TwoCargoBalanceCenterAuto(DriveSubsystem m_drivetrain, Superstructure m_superstructure, Shooter m_shooter) {
		super(m_drivetrain);
